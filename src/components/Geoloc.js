...
class Geoloc extends React.Component {
  render() {
    return !this.props.isGeolocationAvailable ? (
      <div id="weather" className="default"><div>Your browser does not support Geolocation</div></div>
      ...
      <GeolocTrue lat={this.props.coords.latitude} lon={this.props.coords.longitude} />
            ...
            <div id="weather" className="default"><div className="weather__info">Getting the location data&hellip; </div></div>
          );
  }
}
